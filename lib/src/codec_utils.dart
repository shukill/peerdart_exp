...
RTCSessionDescription setPreferredCodec(
  ...
  if (acaps != null) {
    acaps
      ..codecs = acaps.codecs.where((e) => (e['codec'] as String).toLowerCase() == audio).toList()
      ..setCodecPreferences('audio', acaps.codecs);
  ...
  if (vcaps != null) {
    vcaps
      ..codecs = vcaps.codecs.where((e) => (e['codec'] as String).toLowerCase() == video).toList()
      ..setCodecPreferences('video', vcaps.codecs);
